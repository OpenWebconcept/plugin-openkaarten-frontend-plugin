...
- Regex to remove space when searching for a postal code. PDOK does not handle spaces, without it it will rank a match on woonplaatscode higher than postal code.

## [0.4.3] - 2026-09-14

### Changed

- Switched lookup api to pdok
